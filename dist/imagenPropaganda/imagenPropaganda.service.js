...
exports.ImagenPropagandaService = void 0;
const common_1 = require("@nestjs/common");
const cloudinary_config_1 = __importDefault(require("../cloudinary.config"));
let ImagenPropagandaService = class ImagenPropagandaService {
    async subirImagen(imagen) {
        ...
        try {
            const urlImagen = await new Promise((resolve, reject) => {
                const stream = cloudinary_config_1.default.uploader.upload_stream({ folder: 'propaganda' }, (error, result) => {
                    if (error)
                        return reject(error);
    ...
    async borrarImagen(publicId) {
        try {
            ...
            throw new common_1.BadRequestException('Error al borrar la imagen');
        }
    }
};
exports.ImagenPropagandaService = ImagenPropagandaService;
exports.ImagenPropagandaService = ImagenPropagandaService = __decorate([
    (0, common_1.Injectable)()
], ImagenPropagandaService);
//# sourceMappingURL=imagenPropaganda.service.js.map